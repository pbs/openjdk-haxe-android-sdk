...
${bold}${NODENAME} is no longer actively supported!${normal}
   ...
   * ${green}https://deb.nodesource.com/setup_4.x â€” Node.js v4 LTS \"Argon\"${normal} (recommended)
   * ${green}https://deb.nodesource.com/setup_6.x â€” Node.js v6 Current${normal}
